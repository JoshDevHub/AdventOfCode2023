...
def predict(numbers, callback):
    ...
    #                   nice
    # we want the difference between each pair. So this code would all result in:
    # [3, 3, 3, 3, 3]
...
# level up the stack, we had the final number in the list to 0. And this is carried
...
# function with a debugger (also for visualization).
